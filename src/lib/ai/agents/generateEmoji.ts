...
There are several examples attached for your reference inside the below \`example\` XML block. Inside the \`example\` XML block, there will be a \`title\` XML block that contains the title. The emoji generated by the AI agent will be inside the \`emoji\` XML block. You can refer to these examples to understand the task better. Respond only with the emoji character inside the \`emoji\` XML block.
